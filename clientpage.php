...
<section>
  <h3>بيانات العميل</h3>
    <form method="post">
  <div class="uk-margin">
    <b>الإسم :</b><span><input type="text" name="names" value="<?php echo myf2($mmu['name']); ?>"/></span>

  </div>
  <div class="uk-margin">
    <b>رقم التليفون :</b><span><input type="text" name="phone" value="<?php echo myf2($mmu['phone']); ?>"/></span>

  </div>
  <div class="uk-margin">
    <b>العنوان :</b><span><input type="text" name="address" value="<?php echo myf2($mmu['address']); ?>"/></span>

  </div>
  <div class="uk-margin">
    <b>القسم :</b><span> <input type="text" name="section" value="<?php echo myf2($m1232mu['name']); ?>"/></span>

  </div>
  <div class="uk-margin">
    <b>المنطقة :</b><span> <input type="text" name="area" value="<?php echo myf2($m122mu['name']); ?>"/></span>
